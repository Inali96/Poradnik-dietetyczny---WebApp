...
$sql ="SELECT * FROM dieta,przepisy2 WHERE  przepisy2.przepis_nr = dieta.id_diety AND przepisy2.kategoria_ogolna=dieta.kalorycznosc && przepis_nr='7'";
                ...
                <div class="container-fluid">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb" style="background-color: transparent!important;">
                            ...
                            <li class="breadcrumb-item"><a href="dieta1500.php">Diety 7-dniowe: 1500kcal</a></li>
                        </ol>
                    </nav>
                </div>
            </nav>
...
$sql ="SELECT * FROM dieta,przepisy2 WHERE  przepisy2.przepis_nr = dieta.id_diety AND przepisy2.kategoria_ogolna=dieta.kalorycznosc && przepis_nr='7' && dzien='1' ";
...
<?php
$sql ="SELECT * FROM dieta,przepisy2 WHERE  przepisy2.przepis_nr = dieta.id_diety AND przepisy2.kategoria_ogolna=dieta.kalorycznosc && przepis_nr='7'  && dzien='2' ";
$result=mysqli_query($conn,$sql);
if(mysqli_num_rows($result)>0 )
{
    while($row=mysqli_fetch_assoc($result))
...
?>
<?php
$sql ="SELECT * FROM dieta,przepisy2 WHERE  przepisy2.przepis_nr = dieta.id_diety AND przepisy2.kategoria_ogolna=dieta.kalorycznosc&& przepis_nr='7' && dzien='3' ";
$result=mysqli_query($conn,$sql);
if(mysqli_num_rows($result)>0 )
{
    while($row=mysqli_fetch_assoc($result))
...
<?php
$sql ="SELECT * FROM dieta,przepisy2 WHERE  przepisy2.przepis_nr = dieta.id_diety AND przepisy2.kategoria_ogolna=dieta.kalorycznosc && przepis_nr='7' && dzien='4' ";
$result=mysqli_query($conn,$sql);
if(mysqli_num_rows($result)>0 )
{
    while($row=mysqli_fetch_assoc($result))
...
?>
<?php
$sql ="SELECT * FROM dieta,przepisy2 WHERE  przepisy2.przepis_nr = dieta.id_diety AND przepisy2.kategoria_ogolna=dieta.kalorycznosc && przepis_nr='7' && dzien='5' ";
$result=mysqli_query($conn,$sql);
if(mysqli_num_rows($result)>0 )
{
    while($row=mysqli_fetch_assoc($result))
...
?>
<?php
$sql ="SELECT * FROM dieta,przepisy2 WHERE  przepisy2.przepis_nr = dieta.id_diety AND przepisy2.kategoria_ogolna=dieta.kalorycznosc && przepis_nr='7' && dzien='6' ";
$result=mysqli_query($conn,$sql);
if(mysqli_num_rows($result)>0 )
{
    while($row=mysqli_fetch_assoc($result))
...
?>
<?php
$sql ="SELECT * FROM dieta,przepisy2 WHERE  przepisy2.przepis_nr = dieta.id_diety AND przepisy2.kategoria_ogolna=dieta.kalorycznosc && przepis_nr='7' && dzien='7' ";
$result=mysqli_query($conn,$sql);
if(mysqli_num_rows($result)>0 )
{
    while($row=mysqli_fetch_assoc($result))
