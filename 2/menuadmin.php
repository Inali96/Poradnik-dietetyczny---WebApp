                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item nav-link js-scroll" href="dodajprzepis.php">Dodaj przepis</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item nav-link js-scroll" href="lista_uzytkownikow.php">Panel admina</a></li>
                                <div class="dropdown-divider"></div>
